...
function toggleMenu() {
  ...
  if (menuShown) {
    btn.textContent = "luk"; // HVIS JEG BRUGER ET BILLEDE, SÅ SKAL JEG SKEIVE OPEN OG REMOVE OPEN OG SKRIVE DETTE: btn.classList.add("open")
    // hvis nav har klassen "shown", sæt da btn.textContent til "Luk"
  } else {
    btn.textContent = "Menu"; // HVIS JEG BRUGER ET BILLEDE, SÅ SKAL JEG SKEIVE OPEN OG REMOVE OPEN OG SKRIVE DETTE: btn.classList.remove("open")
